...
async def mo_login(
    *,
    ...
    active_user_tenant = await UserTenantDao.aget_active_user_tenant(db_user.user_id)
    tenant_id = active_user_tenant.tenant_id if active_user_tenant is not None else DEFAULT_TENANT_ID
